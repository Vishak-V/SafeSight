...
def play_audio_feedback(text, audio_ready, is_muted):
    ...
    try:
        ...
        while pygame.mixer.get_busy():
            ...
            # --- MODIFICATION: Listen for 'q' and 'm' ---
            ...
            if key == ord('q'):
                ...
                # The loop will exit on its own if sound is stopped
...
def main():
    ...
    # --- MODIFICATION: Add mute state ---
    is_muted = False

    try:
        while True:
            # --- MODIFICATION: Key check moved to top ---
            ...
            try:
                ...
                # --- MODIFICATION: Pass and receive is_muted state ---
            ...
            # --- MODIFICATION: Removed redundant key check ---
            # Graceful Exit Check (primary check)
            # (This is now handled at the top of the loop)
